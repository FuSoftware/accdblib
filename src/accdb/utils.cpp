...
std::vector<unsigned char> *ACCDB::split(std::vector<unsigned char> *data, int offset, int length, bool reverse)
{
...
std::vector<unsigned char> ACCDB::join(std::vector<unsigned char> v1, std::vector<unsigned char> v2)
{
...
unsigned short ACCDB::toUShort(std::vector<unsigned char> *data, bool reverse, int offset)
{
...
unsigned long ACCDB::toULong(std::vector<unsigned char> *data, bool reverse, int offset)
{
...
std::string ACCDB::toString(std::vector<unsigned char> *data, int offset, int length)
{
    std::string s;
    if(length < 0)
...
std::vector<unsigned char> *ACCDB::readFile(std::string path)
{
